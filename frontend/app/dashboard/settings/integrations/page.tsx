...
export default function IntegrationsPage() {
  ...
  const fetchIntegrations = async () => {
    ...
    try {
      ...
      // Helper to find channel account by platform
      ...
      setIntegrations([
        ...
        },
        {
          ...
          status: getChannelStatus('facebook_page'), // Messenger uses same page connection
          config: null,
          channelAccount: findChannelAccount('facebook_page'),
          loading: false,
        ...
        },
        {
          ...
          status: getChannelStatus('instagram_business'), // DM uses same Instagram connection
          config: null,
          channelAccount: findChannelAccount('instagram_business'),
          loading: false,
        ...
        },
        {
          ...
          status: 'inactive', // LinkedIn not yet in schema
          config: null,
          channelAccount: null,
          loading: false,
                ...
                <SettingsCard
                  ...
                  footer={
                    <div className="flex justify-end">
                      <a
                        href={integration.configurePath}
