    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="text-center py-12">
          ...
          <h3 className="text-sm font-medium text-gray-900 mb-2">Instructor Cost Report</h3>
          <p className="text-sm text-gray-500">
            Sessions, hours, total cost, cost per session, cost per hour, revenue generated, and net contribution
          </p>
